-- ================================================
-- COMPLETE SCHEMA SQL UNTUK APLIKASI KASIR MARTABAK TIP TOP
-- NEON.TECH VERSION - LENGKAP DENGAN AUTH
-- ================================================
...
-- ================================================
-- 6. SEED DATA - DEFAULT USERS
-- ================================================

-- Insert default admin user (password: admin123)
INSERT INTO users (email, password_hash, name, role, is_active) VALUES
  ('admin@tiptop.com', '$2a$10$rXKZ9qJ8YvH0p3YvH0p3YOqJ8YvH0p3YvH0p3YvH0p3YvH0p3YvH0', 'Admin Tip Top', 'admin', true)
ON CONFLICT (email) DO NOTHING;

-- Insert default kasir user (password: kasir123)
INSERT INTO users (email, password_hash, name, role, is_active) VALUES
  ('kasir@tiptop.com', '$2a$10$rXKZ9qJ8YvH0p3YvH0p3YOqJ8YvH0p3YvH0p3YvH0p3YvH0p3YvH0', 'Kasir Tip Top', 'kasir', true)
ON CONFLICT (email) DO NOTHING;
...
-- ================================================
-- 11. FUNCTION: Clean Expired Sessions
-- ================================================
...
-- ================================================
-- DONE! 🎉
-- Database schema lengkap dengan auth sudah siap!
-- ================================================

-- CATATAN PENTING:
-- 1. Password hash di atas adalah contoh. Untuk production, gunakan hash yang benar.
-- 2. Untuk generate password hash yang benar, jalankan script Node.js berikut:
--    const bcrypt = require('bcryptjs');
--    console.log(await bcrypt.hash('admin123', 10));
--    console.log(await bcrypt.hash('kasir123', 10));
-- 3. Ganti password hash di atas dengan hasil dari script tersebut.
